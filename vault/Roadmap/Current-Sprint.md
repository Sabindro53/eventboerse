...
- [x] **EB-Motion-3D (visueller Release-Look)**: Scroll-Reveal-Layer mit 6 Varianten (rise/tilt-l/tilt-r/zoom/flip-up/depth, 70ms-Stagger), Pointer-Tilt mit Glanzreflex auf Listing-/Feed-/Board-Karten (nur hover+fine-pointer), 3 schwebende Farb-Orbs im Browse-Hero. Komplett additiv: MutationObserver dekoriert Re-Renders automatisch, keine Render-Funktion angefasst. prefers-reduced-motion schaltet alles ab. Tilt-Spezifität gegen :hover-Transforms abgesichert.
