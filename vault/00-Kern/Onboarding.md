...
> Einstiegspunkt für neue Entwickler:innen und Coding-Agents. Wenn du das hier zum ersten Mal liest, lies anschließend **in dieser Reihenfolge**: [[00-Kern/Glossar]] → [[20-System/Architecture/Overview]] → [[20-System/Architecture/Datenmodell]] → [[20-System/Frontend/app-js-module]] → [[20-System/Backend/API-Endpoints]] → [[40-Governance/Security/2026-05-02-Security-Hardening]].
...
4. **Compliance-First** — DSGVO, DSA, P2B, BFSG. Siehe [[40-Governance/Legal/Compliance-Overview]].
...
1. [[20-System/Architecture/Overview]] — System auf einer Seite
2. [[20-System/Architecture/Datenmodell]] — DB-Schema
3. [[20-System/Architecture/Frontend-Routing]] — wie Seiten geladen werden
4. [[20-System/Backend/API-Endpoints]] — Backend-Vertrag
5. [[40-Governance/Security/Permissions]] — Permission-Callbacks-Pattern
6. [[40-Governance/Security/EBSafeHTML]] — XSS-Schutz-Sanitizer
...
- ❌ `_sanitizeHtml()` ohne Audit lockern (XSS-Risiko, siehe [[40-Governance/Security/EBSafeHTML]])
- ❌ Inline-Eventhandler in App-generiertem HTML (CSP)

## Wenn du verloren bist

→ [[Dashboard]] hat den vollständigen Index.
→ [[00-Kern/Glossar]] erklärt unsere Begriffe.
→ [[50-Evolution/AI-Gedaechtnis/Claude-Kontext]] enthält die Quintessenz.
