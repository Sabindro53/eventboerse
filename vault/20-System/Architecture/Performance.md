...
```
Cache-Buster `?v=` für Invalidierung — siehe [[30-Betrieb/Operations/Runbooks#cache-buster-erhoehen]].
...
- Detail: [[40-Governance/Security/Cache-Strategy]]

### 4. Bilder

- **WebP** wo möglich
- `loading="lazy"` und `decoding="async"` per MutationObserver injiziert (siehe [[20-System/Frontend/app-js-module]])
- Avatar **inline-SVG** (keine Roundtrips, kein DiceBear-Tracking) — siehe [[20-System/Frontend/Avatar-System]]
...
- 8 s-Failsafe (`__hideAppLoader`) — siehe [[20-System/Frontend/Loading-Overlay]]
...
In [[40-Governance/Security/Cache-Strategy]] dokumentiert:
...
- [[40-Governance/Security/Cache-Strategy]]
- [[20-System/Frontend/Loading-Overlay]]
