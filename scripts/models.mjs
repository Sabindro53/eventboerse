...
const ROH_MODELLE = [
  {
    ...
    ausloeser: 'Priorisiert im 5-Minuten-Rundlauf spätestens alle 55 Minuten den nächsten Produkthebel.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Prüft im 5-Minuten-Rundlauf spätestens alle 55 Minuten autonome Änderungen und ihre Seiteneffekte.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Prüft im 5-Minuten-Rundlauf spätestens alle 55 Minuten Deploys, Tests und Erreichbarkeit.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Prüft im 5-Minuten-Rundlauf spätestens alle 55 Minuten Wissen, Datenqualität und neue Signale.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Sichtet im 5-Minuten-Rundlauf spätestens alle 55 Minuten die nächste klar messbare UX-Verbesserung.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Bereitet im 5-Minuten-Rundlauf spätestens alle 55 Minuten den nächsten freigegebenen Kleinst-Patch vor.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Sichtet im 5-Minuten-Rundlauf spätestens alle 55 Minuten Funnel, Anfragen und Angebotslücken.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Prüft im 5-Minuten-Rundlauf spätestens alle 55 Minuten Gebühren, Budget und Abweichungen.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Prüft im 5-Minuten-Rundlauf spätestens alle 55 Minuten die nächste offene Sicherheitsfläche.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Prüft im 5-Minuten-Rundlauf spätestens alle 55 Minuten Regeln, Einwilligungen und Freigaben.',
  ...
  },
  {
    ...
    weg: 'openrouter',
    schicht: 'hq-operations.yml',
    ausloeser: 'Sichtet im 5-Minuten-Rundlauf spätestens alle 55 Minuten neue Fragen und wiederkehrende Unklarheiten.',
 ...
 */
const SCHICHTEN = {
  'hq-operations.yml':      { takt: '24/7-Rundlauf · 1 Rolle je 5 Min. · alle 11 Rollen ≤ 55 Min. · hartes $0,60-Tagesbudget', label: 'HQ Operations-Ensemble' },
