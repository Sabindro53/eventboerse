 ...
 */
const SCHICHTEN = {
  'hq-operations.yml':      { takt: 'alle 30 Min. angefordert (GitHub plant best-effort) · alle 11 Rollen je erreichtem Puls · eigener Topf, hart $0,50/Tag', budgetUsd: 0.50, label: 'HQ Operations-Ensemble' },
  'openrouter-autopilot.yml': { takt: '5-Min.-Prüfung angefordert (gemessen ~41 Min.) · KI bei jedem erreichten Lauf · eigener Topf, hart $1,50/Tag', budgetUsd: 1.50, label: 'OpenRouter Autopilot' },
